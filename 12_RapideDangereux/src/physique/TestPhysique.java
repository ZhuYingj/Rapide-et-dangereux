...
public class TestPhysique {
	/**
	 * Demarrage du test du moteur physique sans dessin les affichages se font a la
	 * console.
	 * 
	...
	public static void main(String[] args) {
		...
		// Vecteur2D fFrottementA = new
		// Vecteur2D(MoteurPhysique.calculerForceFrottement(mu, masseA, 0));
		// Vecteur2D fGraviteA = new Vecteur2D(MoteurPhysique.calculerForceGrav(masseA,
		// 0));
		// fTotaleA = new Vecteur2D(fFrottementA.additionne(fGraviteA));
		// //Vecteur de force de la voiture B
		// Vecteur2D fFrottementB = new
		// Vecteur2D(MoteurPhysique.calculerForceFrottement(mu, masseB, angleRad));
		// Vecteur2D fGraviteB = new Vecteur2D(MoteurPhysique.calculerForceGrav(masseB,
		// angleRad));
