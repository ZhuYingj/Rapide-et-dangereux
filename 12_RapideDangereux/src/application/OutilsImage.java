...
public class OutilsImage {
	...
	/**
	 * Lit le fichier d'image donne en parametre, redimensionne l'image en
	 * appliquant le meme facteur de redimensionnement en largeur et en hauteur (ce
	 * qui evite toute distortion dans l'image).
	 *
	 * Retourne un objet Image correspondant.
	 *
	 * Voir aussi la deuxieme signature de cette methode, qui permet de specifier
	 * des resolutions precises en largeur et hauteur.
	 * 
	 * @param nomFichier  Le nom du fichier d'image
	...
	/**
	 * Lit le fichier d'image donne en parametre, redimensionne l'image a la
	 * nouvelles resolution desiree.
	 *
	 * Retourne un objet Image correspondant
	 *
	 * Attention : si resoX et resoY ne sont pas proportionnels aux dimensions
	 * initiales de l'image, cela introduit une distortion (semblera plus etiree
	 * dans une direction) Voir aussi la deuxieme signature de cette methode qui
	 * permet plutot de donner un facteur de redimensionnement.
	 * 
	 * @param nomFichier Le nom du fichier d'image
